...
Везде, включая [оригинал](https://dou.ua/lenta/articles/interview-questions-net-developer/) на украинском, вопросы с 91 по 99 отсутсвуют.
...
Ответы максимально сократил, убрав детали. Предпочтение старался отдавать документации Микросовфт.  
...
>- Асинхронная коммуникация. Сервисы взаимодействуют без ожидания немедленного ответа, часто через брокеров сообщений, таких как RabbitMQ, Kafka или AWS SQS.
